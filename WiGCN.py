...
from utility.batch_test_wigcn import *
...
class LightGCN(object):
    def __init__(self, data_config, pretrain_data):
        ...
        self.adj_user = data_config['adj_user']
    ...
    def _init_weights(self):
        all_weights = dict()
        # nitializer = tf.random_normal_initializer(mean=0,stddev=0.01)
    ...
    def _split_A_hat(self, X):
        ...
        for i_fold in range(self.n_fold):
            ...
            # W, H, n_iter = non_negative_factorization(X[start:end], n_components=50, init='random', random_state=0)
            H = X[start:end]
    ...
    def _create_tincf_embed(self):
        if self.node_dropout_flag:
            ...
            B_fold_hat = self._split_A_hat(self.adj_user)
...
if __name__ == '__main__':
    ...
    *********************************************************
    ...
    """
    plain_adj, norm_adj, mean_adj, pre_adj, adj_user = data_generator.get_adj_mat()
