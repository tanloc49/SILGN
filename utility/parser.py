...
def parse_args():
    parser = argparse.ArgumentParser(description="Run SILGCN.")
    ...
    parser.add_argument('--dataset', nargs='?', default='librarything',
                        help='Choose a dataset from {gowalla, epinions, library-thing}')
    ...
    parser.add_argument('--model_type', nargs='?', default='silgcn',
                        help='Specify the name of model (silgcn).')
    parser.add_argument('--adj_type', nargs='?', default='silgcn',
    ...
    parser.add_argument('--percent_similar', type=int, default=0.3,
                        help='percent of ')
